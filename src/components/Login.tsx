          ...
          <div className="lg:w-96 space-y-5">
            ...
            <div className="flex justify-between items-center gap-6">
              <div className="text-slate-400 w-full">
                <p className="text-xs flex justify-end">Strong Password </p>
              </div>
            </div>
            ...
            <div className="lg:w-96 border-gray-500 border-2 border-solid py-2 rounded-lg bg-violet-500">
              <button className="w-full">
                <p className="font-bold text-white">Agree and Continue </p>
              </button>
            </div>
          </div>
        </div>
